...
public class ViewDistributionFrame extends JFrame {
    ...
    public void updateDistribution(ReportSnapshot sn){
    ...
    public static class DistributionPanel extends JPanel {
        private volatile ReportSnapshot snapshot;
        private int w;
        private int h;
        ...
        public void paint(Graphics g){
            ...
            final ReportSnapshot sn = snapshot;
        ...
        public void updateDistribution(ReportSnapshot snapshot){
